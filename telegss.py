...
@dp.message_handler(content_types=types.ContentType.CONTACT,state = ST.FirstRegistration.F_NAME_REG)
async def  extract_from_contact(message: types.Message,state=FSMContext):
    '''extracts contact data and save it'''
...
@dp.message_handler(content_types=types.ContentType.CONTACT,state = ST.FirstRegistration.TEL_REG)
